      ...
      <Card>
        ...
        <CardContent className="space-y-2">
          <p className="text-sm text-gray-600">
            <strong>Libre de Vapeo</strong> - Aplicación de seguimiento y apoyo
          </p>
          <p className="text-sm text-gray-600">
            Versión 2.0 - Con seguimiento avanzado de salud
          </p>
          <p className="text-sm text-gray-600">
            Desarrollada para ayudarte en tu viaje hacia una vida libre de vapeo
          </p>
